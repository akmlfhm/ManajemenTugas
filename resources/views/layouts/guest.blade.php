...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            body {
                background-color: #10e16aff;
                background-image: linear-gradient(135deg, #669619ff 0%, #0bc54cff 100%);
            }
        </style>
    </head>
    <body class="font-sans text-gray-900 antialiased">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0">
            <div>
            <a href="/">
                <img src="{{ asset('image/logo-informatika.png') }}" alt="Logo Unimus" class="w-32">
            </a>
        </div>
